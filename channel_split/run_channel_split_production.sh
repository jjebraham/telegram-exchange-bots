...
post="${1:-}"
case "$post" in
  bank-comparison|alanchande-iran-gold|alanchande-fx-pulse|alanchande-turkey-gold|alanchande-iran-fx|alanchande-usdt-exchanges|kiani-examples|kiani-examples-reverse|kiani-try|kiani-rates) ;;
  *)
