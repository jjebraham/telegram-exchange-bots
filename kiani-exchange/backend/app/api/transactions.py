...
async def create_transaction(
    ...
    _log_user_activity("create_order", "miniapp", {"reference_number": req.reference_number, "exchange_type": req.exchange_type, "status": req.status}, user_id=user_id, phone_number=req.user_phone)
...
async def cancel_transaction(
    ...
    _log_user_activity("cancel_order", "miniapp", {"reference_number": reference_number}, user_id=user_id)
