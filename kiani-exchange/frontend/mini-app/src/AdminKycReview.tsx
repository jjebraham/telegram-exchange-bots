  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-6 z-[90] rounded-xl bg-emerald-600 px-4 py-3 font-bold text-white shadow-xl"
      >
        بررسی KYC
      </button>
            ...
            <div className="space-y-3">
              ...
              {items.map(item => (
                <article key={item.id} className="rounded-xl border border-gray-700 bg-gray-800/60 p-4">
                  ...
                  <p className="mt-3 text-xs text-gray-400">تصاویر حساس KYC به‌صورت عمومی سرو نمی‌شوند؛ نسخه تصاویر هنگام ارسال درخواست از طریق ربات ادمین در تلگرام ارسال می‌شود.</p>
                </article>
              ))}
            </div>
          </div>
