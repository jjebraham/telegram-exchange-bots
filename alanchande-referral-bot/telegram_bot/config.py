...
class Settings:
    ...
    early_share_nudge_minutes: int = 5
    early_share_nudge_hours: int = 2  # legacy compatibility; new worker uses minutes
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            nudge_check_seconds=int_env("NUDGE_CHECK_SECONDS", 300, 60),
            early_share_nudge_minutes=int_env("EARLY_SHARE_NUDGE_MINUTES", 5, 1),
